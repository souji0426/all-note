...
\end{itembox}
\ \\
\begin{itembox}[l]{Definition \ref{definition:集合族の共通部分}\ \ 和集合と共通部分(E:p3,\ K:p4~5)\ \ \pageref{definition:集合族の共通部分}ページ}
  $A,B$を集合,
  ...
  \end{itemize}
	\begin{itemize}
		\item[]（ファイルパス）\path{C:/souji/all-note/part/part_不完全性定理勉強会ノート/chapter_導入.tex}
		\item[]（行数）259		（ラベル）definition:集合族の共通部分
	\end{itemize}
\end{itembox}
\ \\
...
\begin{itembox}[l]{Definition \ref{definition:直積集合}\ \ 直積集合(E:p4,\ K:p6)\ \ \pageref{definition:直積集合}ページ}
  ...
  \end{itemize}
	\begin{itemize}
		\item[]（ファイルパス）\path{C:/souji/all-note/part/part_不完全性定理勉強会ノート/chapter_導入.tex}
		\item[]（行数）512		（ラベル）definition:直積集合
	\end{itemize}
\end{itembox}
\ \\
...
\end{itembox}
\ \\
\begin{itembox}[l]{Definition \ref{definition:恒等写像}\ \ 写像(E:p5,\ K:p7~8)\ \ \pageref{definition:恒等写像}ページ}
  集合$A,B$と関係$F$に対して
  \begin{itemize}
    \item[1.]
  ...
  \end{itemize}
	\begin{itemize}
		\item[]（ファイルパス）\path{C:/souji/all-note/part/part_不完全性定理勉強会ノート/chapter_導入.tex}
		\item[]（行数）580		（ラベル）definition:恒等写像
	\end{itemize}
\end{itembox}
\ \\
...
\end{itembox}
\ \\
\begin{itembox}[l]{Definition \ref{definition:順序関係}\ \ 同値関係と順序関係(E:p5~6,\ K:p8~9)\ \ \pageref{definition:順序関係}ページ}
  集合$A$と関係$R$に対して
  \begin{itemize}
    \item[1.]
  ...
  \end{itemize}
	\begin{itemize}
		\item[]（ファイルパス）\path{C:/souji/all-note/part/part_不完全性定理勉強会ノート/chapter_導入.tex}
		\item[]（行数）777		（ラベル）definition:順序関係
	\end{itemize}
\end{itembox}
\ \\
\begin{itembox}[l]{Definition \ref{definition:商集合}\ \ 同値類(E:p6,\ K:p9)\ \ \pageref{definition:商集合}ページ}
  ...
  集合$A$の同値関係$R$による\textbfgt{quotient set}{商集合}という.
	\begin{itemize}
		\item[]（ファイルパス）\path{C:/souji/all-note/part/part_不完全性定理勉強会ノート/chapter_導入.tex}
		\item[]（行数）809		（ラベル）definition:商集合
	\end{itemize}
\end{itembox}
\ \\
...
\begin{itembox}[l]{Notation \ref{notation:自然数全体の集合}\ \ E:p6,\ K:p9\ \ \pageref{notation:自然数全体の集合}ページ}
  自然数全体の集合$\{ 0,1,2,\dots \}$を$\mathbb{N}$で表す.
	\begin{itemize}
		\item[]（ファイルパス）\path{C:/souji/all-note/part/part_不完全性定理勉強会ノート/chapter_導入.tex}
		\item[]（行数）873		（ラベル）notation:自然数全体の集合
	\end{itemize}
\end{itembox}
\ \\
\begin{itembox}[l]{Definition \ref{definition:可算集合}\ \ E:p6,\ K:p9\ \ \pageref{definition:可算集合}ページ}
  集合$A$に対して
  \begin{itemize}
  ...
  \end{itemize}
	\begin{itemize}
		\item[]（ファイルパス）\path{C:/souji/all-note/part/part_不完全性定理勉強会ノート/chapter_導入.tex}
		\item[]（行数）891		（ラベル）definition:可算集合
	\end{itemize}
\end{itembox}
\ \\
\begin{itembox}[l]{Proposition E:p6,\ K:p9}
...
\begin{itembox}[l]{Proposition \ref{proposition:高々可算な無限集合はNへの全単射が存在する}\ \ E:p6,\ K:p9\ \ \pageref{proposition:高々可算な無限集合はNへの全単射が存在する}ページ}
  高々可算な無限集合$A$に対して$A$から$\mathbb{N}$への全単射写像が存在する.
	\begin{itemize}
		\item[]（ファイルパス）\path{C:/souji/all-note/part/part_不完全性定理勉強会ノート/chapter_導入.tex}
		\item[]（行数）948		（ラベル）proposition:高々可算な無限集合はNへの全単射が存在する
	\end{itemize}
\end{itembox}
\ \\
\begin{itembox}[l]{Theorem \ref{theorem:可算集合の要素の有限列全体も可算}\ \ E:p6 THEOREM 0B,\ K:p10 定理0B\ \ \pageref{theorem:可算集合の要素の有限列全体も可算}ページ}
  ...
  $A$の要素からなる有限列全体の集合も高々可算.
	\begin{itemize}
		\item[]（ファイルパス）\path{C:/souji/all-note/part/part_不完全性定理勉強会ノート/chapter_導入.tex}
		\item[]（行数）975		（ラベル）theorem:可算集合の要素の有限列全体も可算
	\end{itemize}
\end{itembox}
\ \\
...
\begin{itembox}[l]{Lemma \ref{lemma:ツォルンの補題}\ \ E:p7 ZORN'S LEMMA,\ K:p12 ツォルンの補題\ \ \pageref{lemma:ツォルンの補題}ページ}
  ...
  つまり$A$はどの$X\in \mathcal{A}$に対しても$A\subsetneq X$となることはない.
	\begin{itemize}
		\item[]（ファイルパス）\path{C:/souji/all-note/part/part_不完全性定理勉強会ノート/chapter_導入.tex}
		\item[]（行数）1090		（ラベル）lemma:ツォルンの補題
	\end{itemize}
\end{itembox}
\ \\
...
\begin{itembox}[l]{Theorem \ref{theorem:シュレーダー・ベルンシュタインの定理}\ \ E:p9 SCH\"{O}DER-BERNSTEIN THEOREM,{\ \\}\hspace{3.5cm}\ K:p14 シュレーダー・ベルンシュタイン（Schr\"{o}der-Bernstein）の定理\ \ \pageref{theorem:シュレーダー・ベルンシュタインの定理}ページ}
  ...
  \end{itemize}
	\begin{itemize}
		\item[]（ファイルパス）\path{C:/souji/all-note/part/part_不完全性定理勉強会ノート/chapter_導入.tex}
		\item[]（行数）1203		（ラベル）theorem:シュレーダー・ベルンシュタインの定理
	\end{itemize}
\end{itembox}
\ \\
\begin{itembox}[l]{Theorem \ref{theorem:比較可能定理}\ \ E:p9 THEOREM 0C,\ K:p14 定理0C\ \ \pageref{theorem:比較可能定理}ページ}
  ...
  \end{itemize}
	\begin{itemize}
		\item[]（ファイルパス）\path{C:/souji/all-note/part/part_不完全性定理勉強会ノート/chapter_導入.tex}
		\item[]（行数）1217		（ラベル）theorem:比較可能定理
	\end{itemize}
\end{itembox}
\ \\
...
\begin{itembox}[l]{Theorem \ref{theorem:基数算術の定理}\ \ E:p9 CARDINAL ARITHMETIC THEOREM,\ K:p15 基数算術の定理\ \ \pageref{theorem:基数算術の定理}ページ}
  ...
  \end{itemize}
	\begin{itemize}
		\item[]（ファイルパス）\path{C:/souji/all-note/part/part_不完全性定理勉強会ノート/chapter_導入.tex}
		\item[]（行数）1253		（ラベル）theorem:基数算術の定理
	\end{itemize}
\end{itembox}
\ \\
\begin{itembox}[l]{Theorem \ref{theorem:無限集合の要素の有限列全体はその集合の濃度に一致}\ \ E:p10 THEOREM 0D,\ K:p15 定理0D\ \ \pageref{theorem:無限集合の要素の有限列全体はその集合の濃度に一致}ページ}
  ...
  $A$の要素からなる有限列全体の集合$\displaystyle \bigcup_{n\in \mathbb{N}}A^{n+1}$の濃度は$\card A$と同じ.
	\begin{itemize}
		\item[]（ファイルパス）\path{C:/souji/all-note/part/part_不完全性定理勉強会ノート/chapter_導入.tex}
		\item[]（行数）1263		（ラベル）theorem:無限集合の要素の有限列全体はその集合の濃度に一致
	\end{itemize}
\end{itembox}
\ \\
