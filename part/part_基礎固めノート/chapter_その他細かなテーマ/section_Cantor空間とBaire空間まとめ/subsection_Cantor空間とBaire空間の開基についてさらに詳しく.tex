...
\begin{definition}[]
  ...
  \end{itemize}
\end{definition}
\RegisterInSymbolList{$\FinitlyDomeinFunc{i}{k}$}{$i\in \omega$を$k$に写す関数}{definition:有限定義域なωから自然数への関数}
\RegisterInSymbolList{$\FinitlyDomeinFunc{i_0,\dots,i_n}{k_0,\dots,k_n}$}{$i_0,\dots,i_n\in \omega$を$k_0,\dots,k_n$に写す関数}{definition:有限定義域なωから自然数への関数}
