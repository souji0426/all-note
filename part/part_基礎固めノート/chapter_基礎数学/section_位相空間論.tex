...
基本的には\cite{basic001:Tsukuda-kika}を（かなり）参考にしています.
...
\footnote{
  台集合とはWikipediaの「数学的構造」のページ\cite{Basic009:wiki-mathematical-structure}によると,
...
定義だけなら\cite{Basic004:Saito-kiso}にも載っていましたが,
閉基にどのような性質があるかはWikipediaの『開基』のページ\cite{Basic006:wiki-basis}を参考にしました.
以下の命題はそれに載っていたものです.
...
またその主張は選択公理と同値になります.
この証明は\cite{Basic002:Uchida-set}（117ページあたりから）を参考にした.
