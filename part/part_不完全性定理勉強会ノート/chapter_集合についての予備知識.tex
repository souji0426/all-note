...
\begin{notation}[E:p2,\ K:p3]
  ...
  \footnote{
    ...
    単に今後その記号を使うという記法の導入にも見える.
    なのでここでは定義ではなく記法としてみました.
  }
  \footnote{
    まぁここより前にたくさん登場してしまっている記号だけど.
  }
...
\RegisterInSymbolList{$\mathbb{Z}$}{整数全体の集合}{notation:整数全体の集合}
\RegisterInSymbolList{$\mathbb{R}$}{実数全体の集合}{notation:実数全体の集合}
