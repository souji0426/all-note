...
\begin{definition}[E:p6,\ K:p9]
  ...
  \begin{itemize}
    ...
    \item[2.] 集合$A$が\textbfgt{at most countable}{高々可算}であるとは,
      $A$から$\mathbb{N}$への単射写像が存在するこという.
    \item[3.] 集合$A$が\textbfgt{countable}{可算}であるとは,
...
\begin{proposition}[E:p6,\ K:p9]
  \begin{enumerate}
    \item 有限集合は高々可算.
    \item 高々可算な無限集合$A$に対して$A$から$\mathbb{N}$への全単射写像が存在する. \qedhere
  \end{enumerate}
\end{proposition}
...
\begin{proof}
  \begin{enumerate}
    ...
    \item
      ...
      すると$\ran(f)=\SetBar{n_i}{i\in \mathbb{N}}$である.
